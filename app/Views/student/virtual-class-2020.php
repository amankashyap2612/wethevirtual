			...
			<div class="row">
				<div class="col-md-8">
					<div class="icon-box mb-0 p-0">
						<h4 class="text-gray pt-10 mt-0 mb-30">2020 Class Sechedule</h4>
					</div>
					<div class="row">
					<?php foreach($class as $cls){ ?>
						<div class="col-md-12" id="transaction-info">
							<h3><?=ucfirst($cls->topic);?></h3>
							<div class="payment-method">
								<div class="row">
									<div class="col-md-6">
										<p>Meeting ID : <?=$cls->username;?></p>
										<p>Password : <?=$cls->password;?></p>
									</div>
									<div class="col-md-6">
										<p>Timing : <?=date('d M Y H:i:s',strtotime($cls->class_time));?></p>
										<p><button type="button" class="btn btn-colored btn-theme-colored2 text-white btn-lg btn-block" onclick="window.open('<?=$cls->zoom_link;?>');">Start Live Streaming</button></p>
									</div>
								</div>
							</div>
						</div>
