		  ...
		  <?php if($page_info->form=='Y'){ ?>
			<div class="col-md-4">
				<div class="icon-box mb-0 p-0">
					<h4 class="text-gray pt-10 mt-0 mb-30">Consultant Registration:</h4>
				</div>
				<form class="form-submit" action="<?=site_url('form/consultant');?>" class="register-form" method="post" enctype="multipart/form-data">
					<div class="row">
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<input placeholder="Organisation/Institution" name="sector" class="form-control" required="" aria-required="true" type="text">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-12">
