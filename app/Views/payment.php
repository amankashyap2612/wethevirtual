			...
			<div class="row">
				<div class="col-md-8 col-md-push-2">
					<div class="text-gray icon-box mb-0 p-0">
						<h3 class="text-theme-colored font-weight-600 text-uppercase mt-0">Payment Details</h3>
						<div class="line-bottom-rounded-theme-colored2"></div>
						<?php if($transaction == "success") { ?> 
						<p class="font-25 text-center">Your payment of <span class="font-25 currency">&#8377;</span> <?= $payment['amount']; ?>  has successfully recieved.</p>
						<p class="font-25 text-center">Your School Admission will confirm after verified your amount with Bank. We will notify you on your email.</p>
						<?php }else{ ?>
						<p class="font-25 text-center">Your payment has failed. Please try again.</p>
						<?= (isset($error_msg)?'<p class="font-25 text-center">'.$error_msg.'</p>':''); ?>
						<p class="font-25 text-center">Feel free to contact us on <a href="mailto:info@thevirtualschool.co.in">info@thevirtualschool.co.in</a></p>
						<?php } ?>
					</div>
				</div>
			</div>
