                            ...
                            <table class="table f-s-13">
                                ...
                                <tbody>
									...
									<tr>
                                        ...
                                        <td id="slide-<?=$sld->id?>"><?= ($sld->status == 'D')?'<a href="#" data-src="'.site_url('/web-admin/slider/change-status-slider').'"    data-id="'.$sld->id.'" data-status="'.$sld->status.'" class="change-status badge badge-primary">ACTIVE</a>':'<a href="#"  data-src="'.site_url('/web-admin/slider/change-status-slider').'"   data-id="'.$sld->id.'" data-status="'.$sld->status.'" class="change-status badge badge-danger">DEACTIVE</a>'; ?></td>
