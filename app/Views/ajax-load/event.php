...
<section >
	<div class="container position-relative p-0 mt-90" style="max-width: 570px;">
		<h3 class="bg-theme-colored2 p-15 pt-10 mt-0 mb-0 text-white">Event Registration</h3>
		<div class="section-content bg-white p-30">
			<div class="row">
				<div class="col-md-12">
					<!-- Register Form Starts -->
					<form action="<?=site_url('form/event_registration');?>" method="post" class="form-submit reservation-form mb-0 bg-silver-deep p-30">
					<div class="row">
						<div class="col-sm-12">
						...
						<div class="col-sm-12">
							<div class="form-group mb-30">
								<input placeholder="Email ID" name="email" class="form-control" required="" aria-required="true" type="text">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group mb-30">
						...
						<div class="col-sm-12">
							<div class="form-group mb-30">
								<input placeholder="Sector/Industry" name="sector" class="form-control" required="" aria-required="true" type="text">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group mb-30">
								<input placeholder="Qualification" name="qualification" class="form-control" required="" aria-required="true" type="text">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group mb-30">
